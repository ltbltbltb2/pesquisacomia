...
Domínio planejado: https://pesquisacomia.com.br (conexão em andamento)
...
Hospedagem estática com Cloudflare Workers Static Assets. `wrangler.jsonc` define a pasta de publicação. A publicação inicial foi realizada por envio direto. Para automatizar atualizações da branch `main`, conectar este repositório ao Worker na Cloudflare. Nenhuma chave deve ser adicionada ao repositório.
