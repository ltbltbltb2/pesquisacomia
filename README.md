...
Site público: https://pesquisacomia.com.br
...
Hospedagem estática com Cloudflare Workers Static Assets. `wrangler.jsonc` define a pasta de publicação. O repositório é conectado à Cloudflare para publicação automática da branch `main`. Nenhuma chave deve ser adicionada ao repositório.
